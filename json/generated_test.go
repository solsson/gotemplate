...
func Test_dict_Keys(t *testing.T) {
	...
	subDict := jsonDict{"map": jsonDict{"sub": jsonDict{"a": 1, "b": 2}}}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := f()
			want := jsonListHelper.AsList(tt.want.Fields())
...
func Test_dict_Merge(t *testing.T) {
	...
	tests := []struct {
		...
		d             jsonDict
		dicts         []jsonIDict
		wantRegular   jsonIDict
		wantOverwrite jsonIDict
		wantDiff      jsonIDict
	}{
		{"Empty", nil, nil, jsonDict{}, jsonDict{}, jsonDict{}},
		{"Add map to empty", nil, []jsonIDict{dictFixture}, dictFixture, dictFixture, dictFixture},
		{"Add map to same map", dictFixture, []jsonIDict{dictFixture}, dictFixture, dictFixture, jsonDict{}},
		{"Add empty to map", dictFixture, nil, dictFixture, dictFixture, jsonDict{}},
		{"Add new1 to map", dictFixture, []jsonIDict{adding1},
			jsonDict{ // Regular mode
				"Add1Int":    1,
				"Add1String": "string1",
				"float":      1.23,
				"int":        123,
				"list":       jsonList{1, "two"},
				"listInt":    jsonList{1, 2, 3},
				"map": jsonDict{
					"sub1": 1,
					"sub2": "two",
				},
		...
		{"Add new2 to map", dictFixture, []jsonIDict{adding2},
			jsonDict{ // Regular mode
				"Add2Int":    2,
				"Add2String": "string2",
				"float":      1.23,
		...
		{"Add new1 & new2 to map", dictFixture, []jsonIDict{adding1, adding2},
			jsonDict{ // Regular mode
				"Add1Int":    1,
				"Add2Int":    2,
				"Add1String": "string1",
